...
export class MainScene extends SheenScene {
  ...
  createPile(options) {
    ...
    var pebbleModelNames = [
      'js/models/pebble1.json',
      'js/models/pebble2.json',
      'js/models/pebble3.json',
      'js/models/pebble4.json',
      'js/models/pebble5.json',
      'js/models/pebble6.json',
      'js/models/pebble7.json'
    ];
